...
namespace In_Lec
{
    class Transformation
    {
                                            ...
                                            float ang)//The list of 3D points will rotate around 2 specific 3D point v1 and v2 using a given angle
        {
            ...
            Transformation.TranslateX(L_Pts, oldx);//Returns the X values of v1 to original place
            Transformation.TranslateY(L_Pts, oldy);//Returns the Y values of v1 to original place
            Transformation.TranslateZ(L_Pts, oldz);//Returns the Z values of v1 to original place
